...
export const AboutProductionCard = () => {
  ...
  return (
    <Card className="group relative min-h-[30rem] overflow-hidden border-0 p-0 shadow-xl md:col-span-2 md:min-h-[32rem] lg:col-span-7 lg:row-span-2 lg:min-h-0">
      <Image
        fill
        alt="Иллюстрация камнеобрабатывающего производства"
      ...
      <Card.Content className="relative z-10 flex h-full flex-col justify-between p-6 sm:p-8">
        <div className="flex items-center justify-between gap-4">
          ...
          <StoneIcon name={production.icon} tone="inverse" />
        </div>
